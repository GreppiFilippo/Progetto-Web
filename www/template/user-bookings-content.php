                ...
                <div class="card-body py-3">
                    <div class="row g-3">
                        <div class="col-md">
                            ...
                            <input type="date" name="booking-date" id="booking-date" class="form-control"
                                            ...
                                            <div class="d-flex flex-sm-column align-items-end justify-content-end gap-2">
                                                ...
                                                <div class="d-flex flex-column align-items-end">
                                                    ...
                                                    <div class="input-group" style="width: 130px;">
                                                        ...
                                                        <input type="number"
                                                            class="form-control text-center dish-quantity-input px-1"
                                                            style="min-width: 50px;" id="dish-<?php echo $dish['dish_id']; ?>"
                                                            name="dishes[<?php echo $dish['dish_id']; ?>]" min="0"
                ...
                <div class="card-body py-3">
                    <div class="row g-3">
                        <div class="col-md">
                            ...
                            <textarea name="booking-notes" id="booking-notes" class="form-control" cols="3"
                                placeholder="Es. allergie, intolleranze, preferenze..."></textarea>
                        </div>
                    </div>
                </div>
            </fieldset>
