...
<main class="container my-5">
    ...
    <?php if (!empty($templateParams["errors"])): ?>
        <div class="alert border border-3 border-dark bg-white text-dark" role="alert" aria-live="assertive">
        ...
        <fieldset>
            ...
            <div class="row">
                <div class="col-12 col-md-6 mb-3">
                    ...
                    <input type="text" id="nome" name="nome" class="form-control" placeholder="Inserire nome..."
            ...
            <div class="mb-3">
                ...
                <div class="input-group">
                    <span class="input-group-text" id="visible-addon"><i class="bi bi-envelope"
            ...
            <div class="mb-3">
                ...
                <div class="input-group">
                    ...
                    <input type="password" class="form-control" id="password" name="password"
                        placeholder="Inserire password..." autocomplete="new-password" required />
                </div>
            </div>

            <div class="mb-3">
                <label for="confermapassword" class="form-label">Conferma Password<span
