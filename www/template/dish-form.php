            ...
            <div class="row">
              <div class="col-md-6">
                ...
                <input type="text" class="form-control" id="dishName" name="dishName"
                  placeholder="Es. Pasta al Pomodoro" required>
              </div>
            ...
            <div class="row">
              <div class="col-md-4">
                ...
                <div class="input-group flex-nowrap">
                  ...
                  <input type="number" class="form-control" id="dishPrice" name="dishPrice" min="0" step="0.50"
              ...
              <div class="col-md-4">
                ...
                <input type="number" class="form-control" id="dishAvailability" name="dishAvailability" min="0"
                  value="20" required>
              </div>
            </div>
          </div>
          ...
          <div class="row mb-4">
            ...
            <div class="row">
              <div class="col-md-6">
                ...
                <div class="form-check mb-2">
                  <input class="form-check-input" type="checkbox" name="specs[]" value="4" id="spec_4">
