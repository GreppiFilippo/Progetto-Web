<main class="container-fluid my-2">
  <div class="row dashboard m-0 mb-2">
    <div class="col-12">
      ...
      <div class="d-flex align-items-center mb-1">
        ...
        <h1 class="h5 mb-0">Dashboard Amministratore</h1>
      </div>
      <!-- Sottotitolo -->
  ...
  <!-- ICONS -->
  <section class="mb-3 ">
    <div class="mb-2 d-flex align-items-center col-md-4">
    ...
    <div class="mb-2 d-flex align-items-center col-md-4">
        ...
        <div class="d-flex flex-column align-items-start justify-content-center">
            <label for="bookings" class="small">Utenti registrati</label>
            <data id="bookings" value="47" class="h2 fw-bold mb-0">342</data>
        </div>
    </div>
    <div class="mb-2 d-flex align-items-center col-md-4">
        <i class="bi bi-currency-euro bg-success-subtle text-success card mx-3"></i>
        <div class="d-flex flex-column align-items-start justify-content-center">
            <label for="bookings" class="small">Incasso giornaliero</label>
            <data id="bookings" value="47" class="h2 fw-bold mb-0">1567.50</data>
        </div>
    </div>
    <div class="mb-2 d-flex align-items-center col-md-4">
        <i class="bi bi-egg-fried bg-info-subtle text-info card mx-3"></i>
        <div class="d-flex flex-column align-items-start justify-content-center">
            <label for="bookings" class="small">Piatti attivi oggi</label>
            <data id="bookings" value="47" class="h2 fw-bold mb-0">18</data>
        </div>
    </div>
  </section>
