...
<body class="container-fluid p-0 overflow-x-hidden">
  ...
  <!-- Navigation -->
  <nav class="navbar navbar-expand-lg navbar-dark sticky-top" aria-label="Navigazione principale">
    <div class="container">
          ...
          <nav aria-label="Link utili">
            ...
            <ul class="list-unstyled small">
              <?php foreach ($templateParams["link_utili"] as $link): ?>
                <li><a href="<?php echo htmlspecialchars((string) $link["link"], ENT_QUOTES, 'UTF-8'); ?>"
                    class="text-decoration-none"><?php echo htmlspecialchars((string) $link["name"], ENT_QUOTES, 'UTF-8'); ?></a>
                </li>
              <?php endforeach; ?>
            </ul>
          </nav>
