...
CREATE TABLE reservation_dishes (
    ...
    CONSTRAINT fk_reservation_dishes_dish FOREIGN KEY (dish_id) REFERENCES dishes(dish_id),
    CONSTRAINT fk_reservation_dishes_reservation FOREIGN KEY (reservation_id) REFERENCES reservations(reservation_id)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE user_specifications (
    ...
    CONSTRAINT fk_user_specifications_user FOREIGN KEY (user_id) REFERENCES users(user_id),
    CONSTRAINT fk_user_specifications_dietary FOREIGN KEY (dietary_spec_id) REFERENCES dietary_specifications(dietary_spec_id)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE dish_specifications (
    ...
    CONSTRAINT fk_dish_specifications_dish FOREIGN KEY (dish_id) REFERENCES dishes(dish_id),
    CONSTRAINT fk_dish_specifications_dietary FOREIGN KEY (dietary_spec_id) REFERENCES dietary_specifications(dietary_spec_id)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
